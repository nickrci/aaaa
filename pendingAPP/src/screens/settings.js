            ...
            <View style={styles.main}>
                ...
                <View style={styles.mainHeader}>
                    <View style={styles.container_header}>
                        <View style={styles.containerAR}>
                            <Text style={styles.textName}>Carlos Eduardo</Text>
                        </View>

                        <View style={styles.containerData}>
                            <Text style={styles.textEmail}>carlos@pending.com</Text>
                            <Text style={styles.textPhone}>+55 11 90000-0001</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.containerBusiness}>
                    ...
                    <View style={styles.containerCards}>
                        ...
                        <View style={styles.cardClient}>
                            <View style={styles.mainInfoCard}>
                                <Text style={styles.textAddress}>Bar do Geraldo</Text>
                            </View>
                        </View>
                    </View>
