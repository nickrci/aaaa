            ...
            <ScrollView
                ...
                <View style={styles.cards}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('transactions')}>
                        <View style={styles.cardClient}>
                            ...
                            <View style={styles.mainInfoCard}>
                                <Text style={styles.key}>Geraldo Bueno</Text>
                                <Text style={styles.keyPhone}>+55 1198975-0185</Text>
                                <View style={styles.clientInfo_}>
                                    <Text style={styles.keyR$}>R$ 400,00</Text>
                    ...
                    <View style={styles.cardClient}>
                        ...
                        <View style={styles.mainInfoCard}>
                            <Text style={styles.key}>Rayssa Besse</Text>
                            <Text style={styles.keyPhone}>+55 1198975-0186</Text>
                            <View style={styles.clientInfo_}>
                                <Text style={styles.keyR$}>- R$ 30,00</Text>
                                <Pressable style={styles.button}>
                                    <Text style={styles.text}>mandar mensagem</Text>
                                </Pressable>
                            </View>
                    ...
                    <View style={styles.cardClient}>
                        ...
                        <View style={styles.mainInfoCard}>
                            <Text style={styles.key}>Nicolas Richard</Text>
                            <Text style={styles.keyPhone}>+55 1198975-0187</Text>
                            <View style={styles.clientInfo_}>
                                <Text style={styles.keyR$}>R$ 0</Text>
                                <Pressable style={styles.button}>
                                    <Text style={styles.text}>mandar mensagem</Text>
                                </Pressable>
                            </View>
